...
int main(int argc, char** argv) {
	...
	Medium_Solid* solid = SolidRegistry.getSolid("HighDensityPolyethylene");
	...
	FunctorCache* thermalConductivityCache = solid->thermalConductivityFunction->createCache();
	std::cout << "lambda(10) = " << (*solid->thermalConductivityFunction)(10.0, thermalConductivityCache) << std::endl;
	std::cout << "lambda(300) = " << (*solid->thermalConductivityFunction)(300.0, thermalConductivityCache) << std::endl;
	...
	std::cout << "h(500.0) = " << (*solid->enthalpyFunction)(500.0, enthalpyCache) << std::endl;
