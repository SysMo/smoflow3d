...
int main(int argc, char** argv) {
	...
	std::cout << "rho(300.0) =  " << (*solid->heatCapacityFunction)(300.0, heatCapacityCache) << std::endl;
	std::cout << "rho(310.0) =  " << (*solid->heatCapacityFunction)(310.0, heatCapacityCache) << std::endl;
