...
double PneumaticFlapperNozzleValve::getTotalPressureForceOnFlapper() {
...
double Valve_PneumaticFlapperNozzleValve_getTotalPressureForceOnFlapper(PneumaticFlapperNozzleValve* valve) {
	return valve->getTotalPressureForceOnFlapper();
}
