/* Submodel SMO_THERMAL_CONDUCTION_01_REGULATING_GAIN skeleton created by AME Submodel editing utility
   ?? ??? 20 10:09:54 2019 */
...
#define _SUBMODELNAME_ "SMO_THERMAL_CONDUCTION_01_REGULATING_GAIN"
...
void smo_thermal_conduction_01_regulating_gainin_(int *n, double rp[5]
...
void smo_thermal_conduction_01_regulating_gain_(int *n
      , double *heatFlow1Index, double *thermalNode1Index
      , double *heatFlow2Index, double *thermalNode2Index
      , double *heatExchangeGain, double *qDot2, double rp[5]
      , int ip[4], int ic[3], void *ps[3])
