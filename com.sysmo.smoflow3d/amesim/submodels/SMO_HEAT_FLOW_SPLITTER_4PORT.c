/* Submodel SMO_HEAT_FLOW_SPLITTER_4PORT skeleton created by AME Submodel editing utility
   Fri Mar 24 10:41:19 2017 */
...
#define _SUBMODELNAME_ "SMO_HEAT_FLOW_SPLITTER_4PORT"
...
/* <<<<<<<<<<<<End of Private Code. */
void smo_heat_flow_splitter_4portin_(int *n, int ic[1], void *ps[1])
...
/*  There are 4 ports.
   ...
   Port 2 has 2 variables:
      ...
      1 heatFlowIndexOut     heat flow index out [smoHFL] multi line macro 'smo_heat_flow_splitter_4port_macro0_'  UNPLOTTABLE
...
void smo_heat_flow_splitter_4port_(int *n, double *heatFlowIndex1
      , double *heatFlowIndexOut, double *thermalNodeIndex
      , double *heatFlowIndex3, double *heatFlowIndex4, int ic[1]
      , void *ps[1])
...
#endif
extern double smo_heat_flow_splitter_4port_macro0_(int *n
      , double *heatFlowIndex1, double *heatFlowIndex3
      , double *heatFlowIndex4, int ic[1], void *ps[1])
...
/* >>>>>>>>>>>>Macro Function macro0 Executable Statements. */
   ...
   double enthalpyFlowIn = HeatFlow_getEnthalpyFlowRate(flowIn1) + HeatFlow_getEnthalpyFlowRate(flowIn3) + HeatFlow_getEnthalpyFlowRate(flowIn4);
