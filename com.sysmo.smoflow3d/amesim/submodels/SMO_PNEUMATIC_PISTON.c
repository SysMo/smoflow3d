...
/*  There are 3 ports.
   ...
   Port 3 has 3 variables:
      ...
      1 f3     force at port3        [N]   multi line macro 'smo_pneumatic_piston_macro0_'
...
void smo_pneumatic_piston_(int *n, double *fluidFlow1Index
      ...
      , double *pistonArea, double *pistonForce, double *length
      , double *volume, double *volumeDot, double rp[3], int ic[2]
      , void *ps[2])
...
/* >>>>>>>>>>>>Calculation Function Executable Statements. */
   PneumaticPiston_compute(_component, *x3, *v3);
...
/*   *fluidState1Index /= ??; CONVERSION UNKNOWN [smoTDS] */
   ...
   *volumeDot /= 1.66666666666667e-05;
}
